  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function o(t) {
        ...
        function a(t) {
          ...
          for (e = 0; e < r; e++)
            n[e] &&
              ((t = n[e].replace(/\*/g, ".*?")), "-" === t[0] ? o.skips.push(new RegExp("^" + t.substr(1) + "$")) : o.names.push(new RegExp("^" + t + "$")));
    ...
    function (t, e, n) {
      ...
      function s(t) {
        ...
        for (n = 0; n < o; n++)
          r[n] &&
            ((t = r[n].replace(/\*/g, ".*?")), "-" === t[0] ? e.skips.push(new RegExp("^" + t.substr(1) + "$")) : e.names.push(new RegExp("^" + t + "$")));
